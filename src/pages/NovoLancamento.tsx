...
import { isPeriodoFechado } from "../service/FechamentoService";
...
const NovoLancamento: React.FC = () => {
    ...
    async function getValues() {
        ...
        const isClosed = await isPeriodoFechado(data.value, user);
        if (isClosed) {
            window.alert("ERRO: O período selecionado está fechado. Não é possível realizar lançamentos.");
            return;
        }
