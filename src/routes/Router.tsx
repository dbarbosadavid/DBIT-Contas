...
import PlanilhaBalanco from "../pages/PlanilhaBalanco";
import IndicesFinanceiros from "../pages/IndicesFinanceiros";
...
const AppRoutes: React.FC = () => {
  return (
    <RouterRoutes>
      ...
      <Route path="/planilha-balanco" element={<PlanilhaBalanco />} />
      <Route path="/indices" element={<IndicesFinanceiros />} />
